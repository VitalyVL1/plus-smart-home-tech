...
public enum QuantityState {
    ...
    @Schema(description = "Товар закончился") ENDED,

    @Schema(description = "Товара мало (низкий остаток)") FEW,

    @Schema(description = "Товара достаточно") ENOUGH,

    @Schema(description = "Товара много") MANY
}