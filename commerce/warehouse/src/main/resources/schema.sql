...
-- Для быстрого поиска бронирований по корзине
CREATE INDEX IF NOT EXISTS idx_booked_products_cart ON booked_products (shopping_cart_id);

-- Для проверки доступности товаров (исключая уже забронированные)
CREATE INDEX IF NOT EXISTS idx_booked_products_product ON booked_products (product_id);
